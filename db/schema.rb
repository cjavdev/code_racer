...
ActiveRecord::Schema.define(version: 20150124184239) do
  ...
  add_index "stage_entries", ["stage_id", "user_id"], name: "index_stage_entries_on_stage_id_and_user_id", unique: true, using: :btree
  ...
  add_index "stages", ["owner_id"], name: "index_stages_on_owner_id", using: :btree
